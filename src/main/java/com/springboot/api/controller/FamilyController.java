...
public class FamilyController {
	...
	@GetMapping("/family-data/{name}")
	public FamilyDetails getFamilyDetailsByname(@PathVariable String name) {
		logger.info("Family Name::"+name);
		FamilyDetails response = familyService.getFamilyDetailsByname(name);
